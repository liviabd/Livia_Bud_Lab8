...
namespace Livia_Bud_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Livia_Bud_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Livia_Bud_Lab8Context context,
